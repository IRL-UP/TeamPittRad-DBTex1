...
- The algorihtms were developed using MATLAB (ver 2021) and Pytorch framework from the DBTex Grand challenge participation by Team-PittRad (University of Pittsburgh).
